...
public class spawner : MonoBehaviour
{
    [TextArea] public string info =
        "This example script show how to trigger a manual search for new objects for the radar to track. You should also call this when you decide to add more objects to a pool then you told the radar would be there at start.  Simply call 'DaiMangou.RadarBuilder3D._3DRadar.doInstanceObjectCheck();'";
